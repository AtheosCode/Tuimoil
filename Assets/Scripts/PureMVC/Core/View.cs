...
*/
/* 
 因为unity不支持高版本的.net库，所以线程安全的using System.Collections.Concurrent不能使用，ConcurrentDictionary要改为Dictionary
 */
#region Using
...
namespace PureMVC.Core
{
    ...
    public class View : IView
    {
        ...
        protected View(string key)
        {
            ...
            //m_mediatorMap = new ConcurrentDictionary<string, IMediator>();//unity .net库版本问题
            m_observerMap = new Dictionary<string, IList<IObserver>>();
            //m_observerMap = new ConcurrentDictionary<string, IList<IObserver>>();//unity .net库版本问题
        ...
        static View()
        {
            ...
            //m_instanceMap = new ConcurrentDictionary<string, IView>();//unity .net库版本问题
        }
